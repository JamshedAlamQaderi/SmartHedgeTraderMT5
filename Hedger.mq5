...
double CalculateRequiredLotForRebalance(double diffVolume, ENUM_POSITION_TYPE rebalanceSide)
  {
   ...
   double diffVolumeProfitDistance = (diffVolume * 100.0) * (InpProfitTarget * _Point) * remainingDistancePercent;
   ...
   double initialLotProfitDistance = (InpInitialLot * 100.0) * (InpProfitTarget * _Point) * remainingDistancePercent;
   ...
   return NormalizeDouble(MathCeil((minRequiredDistanceToClose / (InpProfitTarget * _Point * remainingDistancePercent))/100.0), _Digits);
  }
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
